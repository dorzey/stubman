...
var Main = function() {
    ...
    self._parseCollection = function (path) {
    ...
    self._buildServer = function(requestsGroupedByUrl) {
    ...
    self._groupRequestsByUrl = function (collectionData) {
    ...
    self.start = function() {
        ...
        var collectionData = self._parseCollection(process.cwd() + "/" + program.collection);
        var requestsGroupedByUrl = self._groupRequestsByUrl(collectionData);

        console.log(requestsGroupedByUrl);
        self._buildServer(requestsGroupedByUrl);
    };
